...
bool Texture::LoadTexture()
{
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, width, height, 0, GL_RGB, GL_UNSIGNED_BYTE, texData); //Load data to binded texture
...
bool Texture::LoadTextureA()
{
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, texData); //Load data to binded texture
	glGenerateMipmap(GL_TEXTURE_2D);
